...
#if 0	// configCPU_CLOCK_HZ is not used
//#define configCPU_CLOCK_HZ			( ( unsigned long ) 47923200 ) //FPGA
#define configCPU_CLOCK_HZ				( ( unsigned long ) 249750000U ) //ASIC DDR_499
#endif
...
// PI5008 specific define. Used for debug purposes only.
...
#define configTIMER_TASK_STACK_DEPTH			0x200	/* Daemon stack size */
