 ...
 * brief
	Get 16 bit CRC
 */
uint16 crc_GetCrc16Ccitt (uint8 *buf, uint16 length);
uint32 CalcCRC16IBM(uint8 *buf, int size);

///////////////////////////////////////////////////////////////////////////////////////////
// Performance Counter
extern void reset_pf_counts (uint32 index);
extern void startPFM (uint32 index);
extern void stopPFM (uint32 index);
extern void printPFM (uint32 index);
